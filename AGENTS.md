...
Context for coding agents working in this repo. Humans want [README.md](README.md) instead; this file
is the short version of what not to break.
...
published `@timedomain/acestudio-tempo-map-calc` npm package (as WebAssembly). There is no second
implementation to keep in sync — that is the point of the repo.
...
| `fixtures/tempo_curve_cases.json` | golden inputs/outputs, asserted against by this repo *and* by downstream consumers. Generated — **never hand-edit** |
